...
class DemographicAnalyzerTestCase(unittest.TestCase):
    ...
    def test_race_count(self):
        ...
        self.assertEqual(actual, expected, msg="Expected race count values to be [27816, 3124, 1039, 311, 271]")
    ...
    def test_percentage_bachelors(self):
        ...
        expected = 16.4
        self.assertAlmostEqual(actual, expected, places=1, msg="Expected different value for percentage with Bachelors degrees.")

    def test_higher_education_rich(self):
        actual = self.data['higher_education_rich']
        expected = 46.5
        self.assertAlmostEqual(actual, expected, places=1, msg="Expected different value for percentage with higher education that earn >50K.")

    def test_lower_education_rich(self):
        actual = self.data['lower_education_rich']
        expected = 17.4
        self.assertAlmostEqual(actual, expected, places=1, msg="Expected different value for percentage without higher education that earn >50K.")
    ...
    def test_rich_percentage(self):
        ...
        expected = 10.0
        self.assertAlmostEqual(actual, expected, places=1, msg="Expected different value for percentage of rich among those who work fewest hours.")
